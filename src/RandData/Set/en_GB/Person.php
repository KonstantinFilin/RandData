...
class Person extends \RandData\Set
{
    ...
    public function getFirstNameFemale()
    {
        return [
            ...
            'Bella', 'Brianna', 'Brielle', 'Brooke', 'Brooklyn',
            'Brooklynn', 'Camila', 'Caroline', 'Catherine', 'Cecilia',
            ...
            'Jordyn', 'Josephine', 'Julia', 'Juliana', 'Julianna',
            'Juliette', 'Katherine', 'Kayla', 'Kaylee', 'Kendall',
